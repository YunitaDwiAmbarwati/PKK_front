                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner_content">
                            <h3 class="text-uppercase">Ok-Fix </h3>
                            <h1 class="text-uppercase">Vehicle Repair Specialist</h1>
                            <!-- <h2 class="text-uppercase">panggil saja Ok-fix</h2> -->
            ...
            <div class="row justify-content-start align-items-center">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="main_title text-left">
                        <h2>tentang <br> kami <br>
                        </h2>
                        <p>
                            Kami menyediakan platform layanan reparasi kendaraan bermotor, yang berisi fitur untuk memesan montir dan mencari bengkel terdekat secara online
                        </p>
                        <p>
